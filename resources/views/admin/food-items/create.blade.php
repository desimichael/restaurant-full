                        ...
                        <div class="card-body">
                             <form method="POST" action="/admin/food-items">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="inputdescription" type="text" class="form-control form-control-lg @error('description') is-invalid @enderror" name="description" autofocus placeholder="Write description here...">{{ old('description') }}</textarea>
