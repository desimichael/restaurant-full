        ...
        <div class="ecommerce-widget">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-muted">Customers Total</h5>
                            <div class="metric-value d-inline-block">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-muted">Reservations Total</h5>
                            <div class="metric-value d-inline-block">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-muted">Employee Total</h5>
                            <div class="metric-value d-inline-block">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9">
                                                <a href="/admin/reservations" class="btn btn-outline-light float-right">
                                                View Details
                                                </a>
                                            </td>    
                                        </tr>
