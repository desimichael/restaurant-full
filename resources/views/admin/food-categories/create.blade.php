            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">New Food Catergory </h2>
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">New Food Categories</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                            ...
                            <div class="form-group">
                                <label for="inputCategoryImgUrl">Category Image URL</label>
                                <input id="inputCategoryImgUrl" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="http://www.tonys.com/img/wings.jpg" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
