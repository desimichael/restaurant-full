    ...
    <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Edit Food Catergory </h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Create Edit Category</h5>
                    <div class="card-body">
                        <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                            ...
                            <div class="form-group">
                                <label for="inputCategoryEdit">Category Image URL</label>
                                <input id="inputCategoryEdit" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="http://www.tonys.com/img/wings.jpg" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
